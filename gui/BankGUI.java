...
public class BankGUI extends JFrame implements ActionListener {
	...
	//1.
	JPanel panel_transfer_top, panel_transfer_mid, panel_transfer_bottom;
	JButton btn_transfer, btn_goback;
	JTextField txt_account, txt_money, txt_message;
	JLabel label_account, label_money, label_message;
	BankBiz biz = new BankBiz();
	BankDto my = biz.selectOne("01012341234");
	...
	public BankGUI() {
		...
		btn_transfer.setBounds(238, 6, 150, 50);
		...
		banner_transfer.setIcon(new ImageIcon("/images/banner_main.png"));
	...
	public void transferMoney(BankDto sender, String receiverAccount, int sendMoney, String message) {
		//passwordChk.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		String processRes = "";
		//(1)계좌 유효성 검사
...
/*
	...
	class BankEvent extends WindowAdapter implements ActionListener{
	

		@Override
		public void actionPerformed(ActionEvent e) {
			boolean processRes = false;
